...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      "fixed inset-0 z-50 bg-white/10 dark:bg-black/80 backdrop-blur-sm transition-all duration-300 " +
  ...
  "fixed z-50 gap-4 bg-white p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 dark:bg-gray-900",
  {
    variants: {
      side: {
        ...
        right:
          "inset-y-0 right-0 h-full w-3/4  border-l border-neutral-200 dark:border-neutral-800 data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right sm:max-w-sm",
      },
    },
    defaultVariants: {
      side: "right",
