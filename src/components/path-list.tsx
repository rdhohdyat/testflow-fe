      ...
      <CardContent className="flex-1 overflow-hidden flex flex-col pt-4">
            ...
            paths.map((item: any, index: number) => (
              ...
              >
                <div className="flex items-center gap-3 flex-1 min-w-0">
                  ...
                  <div className="font-mono text-[11px] font-bold text-neutral-600 dark:text-neutral-300 truncate">
                ...
                {item.passed ? (
                  ...
                  <CircleX className="flex-shrink-0 w-5 h-5 text-neutral-300 dark:text-neutral-600" />
                )}
              </div>
            ))
          ) : (
            <div className="flex flex-col items-center justify-center h-full text-neutral-300 dark:text-neutral-700 gap-2 opacity-50">
        ...
        <div className="mt-6 pt-4 border-t border-neutral-50 dark:border-neutral-800">
          <Sheet>
            ...
            <SheetContent className="w-full md:w-[500px] flex flex-col border-none bg-white dark:bg-neutral-900 p-0 shadow-3xl" side="right">
              <SheetHeader className="p-8 border-b border-neutral-50 dark:border-neutral-900">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <SheetTitle className="text-xl uppercase font-black tracking-tighter text-neutral-900 dark:text-white">Detail Test Case</SheetTitle>
                </div>
              ...
              <div className="flex-1 overflow-y-auto px-8 py-6 space-y-6 custom-scrollbar dark:bg-neutral-900">
                {paths && paths.length > 0 ? (
                    ...
                    return (
                      <Card key={index} className={`border-none rounded-[2rem] shadow-xl shadow-neutral-100/50 dark:shadow-none overflow-hidden ${
                        ...
                        <CardContent className="p-6 space-y-4">
                          <div>
                            <span className="text-[10px] font-black text-neutral-400 dark:text-white uppercase tracking-wider block mb-2">Input Parameter</span>
                            <pre className="p-4 bg-white/60 dark:bg-neutral-900/50 rounded-xl border border-white/50 dark:border-neutral-800 text-[11px] font-bold text-neutral-600 dark:text-neutral-300 overflow-x-auto">
                              {JSON.stringify(item.testCase, null, 2)}
                            </pre>
                          </div>
                          <div>
                            <span className="text-[10px] font-black text-neutral-400 dark:text-neutral-500 uppercase tracking-wider block mb-2">Jalur Eksekusi</span>
                            <div className="font-mono text-[10px] font-bold text-neutral-500 dark:text-neutral-400 bg-white/60 dark:bg-neutral-900/50 px-4 py-2 rounded-xl border border-white/50 dark:border-neutral-800 leading-relaxed">
                  ...
                  <div className="text-center py-20 text-neutral-300 dark:text-neutral-800">
              ...
              <SheetFooter className="p-8 border-t border-neutral-50 dark:border-neutral-900 bg-neutral-50/30 dark:bg-neutral-900/50">
                <SheetClose asChild>
                  <Button className="w-full h-12 rounded-2xl bg-neutral-900 dark:bg-neutral-100 text-white dark:text-black font-black tracking-widest shadow-xl">TUTUP ANALISIS</Button>
                </SheetClose>
              </SheetFooter>
            </SheetContent>
          </Sheet>
