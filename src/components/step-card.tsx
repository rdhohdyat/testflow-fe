...
const StepCard = ({ icon, title, description, index }: StepCardProps) => {
  return (
    <Card className="border border-zinc-50 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-xl shadow-zinc-100 dark:shadow-none rounded-[3rem] p-4 hover:shadow-2xl hover:shadow-emerald-100/30 dark:hover:border-emerald-500/30 transition-all duration-500 group">
      <CardContent className="p-8 flex items-start gap-6">
        <div className="relative shrink-0">
          ...
          <div className="absolute -bottom-2 -right-2 px-2.5 py-1 rounded-lg bg-emerald-500 text-white text-[10px] font-black tracking-tighter shadow-md border-2 border-white dark:border-zinc-900">
