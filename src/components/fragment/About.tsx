...
const About = () => {
  return (
    <section id="about" className="px-8 py-20 bg-neutral-50 dark:bg-neutral-900/10 overflow-hidden">
      <div className="container max-w-6xl mx-auto">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            ...
            <h2 className="mb-6 text-4xl md:text-5xl font-black text-neutral-900 dark:text-white tracking-tighter leading-tight">
              Tentang <span className="italic text-emerald-600">TestFlow</span>
            </h2>

            <p className="mb-8 text-lg text-neutral-400 font-medium leading-relaxed">
            ...
            <Card className="rounded-[3rem] border-none bg-white shadow-2xl shadow-neutral-200/50 dark:shadow-none p-4">
              <CardContent className="flex flex-col gap-8 p-10">
                <div className="flex gap-6 items-start">
                  <div className="p-4 rounded-2xl bg-neutral-900 text-white shadow-xl shadow-neutral-200 dark:shadow-none dark:border">
                    <Code2 className="w-6 h-6" />
                  </div>
                  <div>
                    <h4 className="font-black text-lg text-neutral-900 dark:text-emerald-600 mb-1 tracking-tight">Transformasi Kode</h4>
                ...
                <div className="flex gap-6 items-start">
                  ...
                  <div>
                    <h4 className="font-black text-lg text-neutral-900 dark:text-emerald-600 mb-1 tracking-tight">Analisis CFG</h4>
                    <p className="text-sm leading-relaxed text-neutral-400 font-medium">
                ...
                <div className="flex gap-6 items-start">
                  ...
                  <div>
                    <h4 className="font-black text-lg text-neutral-900 dark:text-emerald-600 mb-1 tracking-tight">Edukasi Visual</h4>
                    <p className="text-sm leading-relaxed text-neutral-400 font-medium">
