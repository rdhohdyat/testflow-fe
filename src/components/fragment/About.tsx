        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            ...
            <h2 className="mb-6 text-4xl md:text-5xl font-black text-zinc-900 dark:text-white tracking-tighter leading-tight">
              Tentang <span className="italic text-zinc-900/10">TestFlow</span>
            </h2>
            ...
            <Card className="rounded-[3rem] border-none bg-white shadow-2xl shadow-zinc-200/50 p-4">
              <CardContent className="flex flex-col gap-8 p-10">
                <div className="flex gap-6 items-start">
                  <div className="p-4 rounded-2xl bg-zinc-900 text-white shadow-xl shadow-zinc-200">
                    <Code2 className="w-6 h-6" />
                  </div>
                  <div>
                    <h4 className="font-black text-lg text-zinc-900 mb-1 tracking-tight">Transformasi Kode</h4>
                ...
                <div className="flex gap-6 items-start">
                  <div className="p-4 rounded-2xl bg-emerald-50 text-emerald-600 shadow-xl shadow-emerald-100">
                    <Search className="w-6 h-6" />
                  </div>
                  <div>
                    <h4 className="font-black text-lg text-zinc-900 mb-1 tracking-tight">Analisis Prefektur</h4>
                    <p className="text-sm leading-relaxed text-zinc-400 font-medium">
                ...
                <div className="flex gap-6 items-start">
                  <div className="p-4 rounded-2xl bg-zinc-50 text-zinc-400">
                    <BookOpen className="w-6 h-6" />
                  </div>
                  <div>
                    <h4 className="font-black text-lg text-zinc-900 mb-1 tracking-tight">Edukasi Visual</h4>
                    <p className="text-sm leading-relaxed text-zinc-400 font-medium">
