...
const Footer = () => {
  return (
    <footer className="px-8 pb-10 bg-white dark:bg-neutral-950 font-sans">
      <div className="container mx-auto p-10 md:p-14 bg-white dark:bg-neutral-900 rounded-[3rem] border border-neutral-200 dark:border-neutral-800 shadow-2xl shadow-neutral-200/50 dark:shadow-none">
