    ...
    >
      <div className="container max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            <Card className="border-none bg-neutral-50 dark:bg-neutral-900 rounded-[2.5rem] shadow-2xl shadow-zinc-100 dark:shadow-none overflow-hidden">
              <CardHeader className="p-8 pb-4 border-b border-zinc-50 dark:border-neutral-800 bg-white dark:bg-neutral-900">
                ...
                >
                  ...
                  <div className="space-y-3">
                    ...
                    <Input
                      ...
                      className="h-14 rounded-xl border-none bg-white dark:bg-neutral-800 shadow-sm dark:shadow-none focus-visible:ring-emerald-500 font-bold dark:text-white"
                      required
                    />
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="relative">
                      <Input
                        ...
                        className="h-14 pl-12 rounded-xl border-none bg-white dark:bg-neutral-800 shadow-sm dark:shadow-none focus-visible:ring-emerald-500 font-bold dark:text-white"
                        required
                      />
