          ...
          {codes.length === 0 ? (
            ...
            [...codes].reverse().map((item) => (
              <div
                key={item.id}
                className={cn(
                  "group flex items-start gap-1 p-3 rounded-lg text-left transition-all border cursor-pointer",
              ...
              >
                ...
                <button
                  ...
                  className="opacity-0 group-hover:opacity-100 transition-opacity p-1 rounded hover:bg-red-50 text-neutral-300 hover:text-red-500 flex-shrink-0"
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      <AlertDialog open={!!analysisToDelete} onOpenChange={(open) => !open && setAnalysisToDelete(null)}>
        <AlertDialogContent className="z-[100] rounded-3xl border-none shadow-2xl p-8 max-w-[400px]">
          <AlertDialogHeader>
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <div className="space-y-2">
                <AlertDialogTitle className="text-xl font-bold text-zinc-900">Hapus Analisis?</AlertDialogTitle>
